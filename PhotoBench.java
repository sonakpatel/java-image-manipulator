...
public class PhotoBench
{
    ...
    private static final String VERSION = "Version 2010-11";
    ...
    private List<Filter> createResizeFilters()
    {
        ...
        filterList.add(new BilinearLargerX2("Bilinear Larger x2"));
        filterList.add(new BilinearSmallerX2("Bilinear Smaller x2"));
        return filterList;
    }
    ...
    private List<Filter> createColourReductionFilters()
    {
        ...
        filterList.add(new FSDitherMonoPrinter("Floyd-Steinberg dither: mono printer"));
        filterList.add(new FSDitherColourPrinter("Floyd-Steinberg dither: colour printer"));
        filterList.add(new WebSafe("Web Safe colours"));
        return filterList;
    }
